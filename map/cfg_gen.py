...
config.set('min_size', 'deep_ocean_min', '10')
config.set('min_size', 'shallow_ocean_min', '10')
config.set('min_size', 'coral_reef_min', '5')
config.set('min_size', 'kelp_forest_min', '10')
config.set('min_size', 'ice_min', '10')
config.set('min_size', 'tiaga_min', '10')
config.set('min_size', 'tundra_min', '10')
config.set('min_size', 'sand_beach_min', '10')
config.set('min_size', 'steppe_min', '10')
config.set('min_size', 'plains_min', '10')
config.set('min_size', 'forest_min', '10')
config.set('min_size', 'swamp_min', '10')
config.set('min_size', 'desert_min', '10')
config.set('min_size', 'savanna_min', '10')
config.set('min_size', 'rainforest_min', '10')
config.set('min_size', 'mountain_min', '10')
...
with open('biomes.cfg', 'w') as configfile:
